...
export default function TeacherCard({ teacher, onEnroll }: TeacherCardProps) {
  return (
    <div
      className="w-[342px] min-w-[342px] max-w-full"
      style={{
        padding: "20px",
        borderRadius: "16px",
    ...
    >
      ...
      <div className="flex items-start gap-3 w-full">
        ...
        <div className="flex flex-col justify-center gap-0.5 min-h-20">
          <p className="text-[18px] font-bold text-gray-900 leading-tight">{teacher.name}</p>
          <p className="text-[14px] text-gray-500">{teacher.role}</p>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-2 w-full text-[13px] mt-auto">
        <div className="flex justify-between items-center w-full">
          ...
          <span className="font-semibold text-gray-900">{teacher.price}</span>
        </div>
        <div className="flex justify-between items-center w-full">
        ...
        <div className="flex justify-between items-center w-full">
          ...
          <span className="font-semibold text-gray-900">{teacher.certificates}</span>
        </div>
      </div>
