  ...
  return (
    <section className="bg-white py-16">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <motion.p
          className="text-base text-slate-600 max-w-3xl mb-8 leading-relaxed"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <Link
            href="/Universities"
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg border border-blue-600 text-blue-600 text-sm font-semibold hover:bg-blue-50 transition-colors group"
          >
            Наши университеты
